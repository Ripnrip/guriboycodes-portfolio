export const portfolioData = {
  ...
  skills: {
    mobile: [
      ...
      { name: "SwiftUI", icon: "swiftui.svg", level: 90 },
      { name: "Objective-C", icon: "objective-c.svg", level: 85 },
      { name: "UIKit", icon: "uikit.svg", level: 90 },
      { name: "CoreML / MLX", icon: "core-ml.svg", level: 85 },
      { name: "ARKit / RoomPlan", icon: "arkit.svg", level: 80 },
      { name: "Combine / RxSwift", icon: "rxswift.svg", level: 85 },
      { name: "Flutter & Dart", icon: "flutter.svg", level: 80 }
    ],
    ai_ml: [
      { name: "Python", icon: "python.svg", level: 90 },
      { name: "LLM Orchestration", icon: "langchain.svg", level: 95 },
      { name: "RAG Pipelines", icon: "rag-pipelines.svg", level: 95 },
      { name: "Multi-Agent Systems", icon: "crewai.svg", level: 90 },
      { name: "GraphRAG", icon: "langgraph.svg", level: 85 },
      { name: "Stable Diffusion / SDXL", icon: "stable-diffusion.svg", level: 80 },
      { name: "Computer Vision", icon: "computer-vision.svg", level: 85 },
      { name: "Prompt Engineering", icon: "anthropic.svg", level: 95 }
    ],
    cloud_devops: [
      { name: "AWS", icon: "aws.svg", level: 85 },
      { name: "GCP / Azure", icon: "googlecloud.svg", level: 80 },
      { name: "Docker", icon: "docker.svg", level: 80 },
      { name: "GitHub Actions", icon: "github-actions.svg", level: 90 },
      { name: "CI/CD / Fastlane", icon: "fastlane.svg", level: 90 },
      { name: "Firebase / Supabase", icon: "firebase.svg", level: 85 }
    ],
    frontend_data: [
      { name: "React / Next.js", icon: "nextjs.svg", level: 90 },
      { name: "Tailwind CSS", icon: "palette.svg", level: 95 },
      { name: "Three.js / WebGL", icon: "box.svg", level: 75 },
      { name: "Framer Motion", icon: "activity.svg", level: 85 },
      { name: "PostgreSQL / MongoDB", icon: "mongodb.svg", level: 85 },
      { name: "Vector DBs", icon: "chromadb.svg", level: 90 }
    ]
  }
};
